...
lyricalCompositionsSongs = {
    ...
    partsInBooks: {
        "Concert Lead Sheets": {
            ...
            "News from Milan": [ "Concert Lead Sheet" ], 
...
// https://alttal.com/media/pdf/open-the-gates/elaine.pdf
    ...
    songs: {
        ...
        "News from Milan": {
            ...
            baseUrl: 'https://altjazz.org/scores/lyrical-compositions/', 
            pdfSubdir: "",
            fileLocation: "news-from-milan",
            filePrefix: "news-from-milan-",
            parts: {
                "Concert Lead Sheet": { fileSuffix: "Lead-Sheet-C" },
            },
            scores: {
            ...
            recordings: {
                album: {
                    description: 'Track 5 from Open the Gates! as mp3',
                    url: 'https://alttal.com/media/mp3/open-the-gates/News%20from%20Milan.mp3'
                },
                youtube: {
                    description: 'From Open the Gates! playlist on youtube',
                    url: 'https://www.youtube.com/watch?v=NoYvp8pKftY&list=OLAK5uy_mRX13K7hUUUolZs7rAmpikIUX1j2czEUM&index=5'
                },
            }
        },        
